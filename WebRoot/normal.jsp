...
<html>
  ...
  %>
	<script type="text/javascript">
		...
		function deletetr(obj){
			...
			var flag = confirm('你是否要删除【'+username+'】的信息？');
			if(flag==true){
		...
		function modifytr(obj){
			...
			var power = uname[3].innerText;
			var flag = confirm('你是否要修改【'+username+'】的信息？');
			if(flag==true){
			//window.location.href="modify.jsp";
				var url = "modify.jsp?username="+username+"&password="+password+"&age="+age+"&power="+power;
				_url = encodeURI(url);
				this.location.href = _url;
			}
		}
  ...
  <body>
  	...
  	<div class="limit">
    <div class="welcome">
    欢迎您，普通用户<font id="loginname"><%=session.getAttribute("nameinput") %></font>，您只有查询的权限！<br>
    </div>
    <hr class="hr1">
